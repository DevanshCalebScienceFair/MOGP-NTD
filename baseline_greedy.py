...
# Column indices within the (N, 3) ADMET matrix, in load_library() order
# [Caco2_logPapp, Half_Life_hours, hERG_Toxicity_Prob]. Used by the hard filters.
CACO2_COL = 0
HALFLIFE_COL = 1
HERG_COL = 2
...
class GreedyFilterThenDock:
    ...
    def run(self):
        ...
        for b in range(n_batches):
            ...
            print(f"[Iteration {iteration}] "
                  ...
                  f"batch={len(batch)}, "
                  f"docked_this_batch={n_docked}/{len(batch)}, "
    ...
    def save_results(self, output_dir="baseline_greedy_results"):
        ...
        # evaluated.csv — every docked molecule with all 4 objectives.
